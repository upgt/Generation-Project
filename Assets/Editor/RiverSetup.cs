...
public class AQUAS_RiverSetup : EditorWindow {
    ...
    void CreateRiverReference() {
        ...
        string filename = string.Format("{0}/RiverReferences/Reference_{1}.jpg", " ", System.DateTime.Now.ToString("yyyy-MM-dd-HH-mm-ss"));

        if (!System.IO.Directory.Exists(string.Format("{0}/RiverReferences", " ")))
        {
            System.IO.Directory.CreateDirectory(string.Format("{0}/RiverReferences", " "));
        }
